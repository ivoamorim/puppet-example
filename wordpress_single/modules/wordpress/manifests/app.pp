class wordpress::app {
 ...
 $php = $::operatingsystem ? {
  ...
  file { '/etc/httpd/conf/httpd.conf':
      ...
      group  => 'root',
      mode   => 644,
      source => 'puppet://master.home/wordpress_app/httpd.conf',
      notify => Service['httpd'],
  }
  ...
  file { '/var/www/html/index.php':
    ...
    group   => 'root',
    mode    => 644,
    source  => 'puppet://master.home/wordpress_app/index.php',
    require  => [Package[$php, $phpmb, $phppear]],
  }
  ...
  file {
    ...
    '/etc/httpd/conf.d/wordpress.conf':
      ...
      group   => 'root',
      mode    => 644,
      source  => 'puppet://master.home/wordpress_app/wordpress.conf',
      require  => Package[$apache, $php, $wordpress],
      notify  => Service['httpd'];
  }
